...
public class MM131 extends Instruction {
    public MM131() {
        ...
        addAction(new Action(1,new KeyElement(KeyElement.FIND_TYPE_CLASS,"nav",null,
                new KeyElement(KeyElement.FIND_TYPE_TAG,"a",null,KeyElement.RESULT_TYPE_ATTR,"href")),1,0,
                new Action(1,new KeyElement(KeyElement.FIND_TYPE_CLASS,"list-left public-box",null,
