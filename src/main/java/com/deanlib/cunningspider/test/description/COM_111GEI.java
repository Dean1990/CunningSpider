...
public class COM_111GEI extends Site {
    ...
    public COM_111GEI(){
        setList(new Page("https://111gai.com/p01/index.html",new Action(new Key(
        ...
        setResource(new Page("https://111gai.com/htm/2020/5/7/p01/465175.html",new Action(new Key(
                null,null,
